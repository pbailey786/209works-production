      ...
      sections={[
        {
          ...
          description:
            'Terms governing how employers can use the 209jobs platform and services',
          wireframeType: 'list',
          items: [
        ...
        },
        {
          ...
          description:
            'Rules and requirements for creating and managing job listings',
          wireframeType: 'list',
          items: [
        ...
        },
        {
          ...
          description:
            'Terms related to subscription plans, billing, credits, and payment processing',
          wireframeType: 'list',
          items: [
        ...
        },
        {
          ...
          description:
            'Terms governing access to and use of candidate information',
          wireframeType: 'list',
          items: [
        ...
        },
        {
          ...
          description:
            'Terms related to content ownership, trademarks, and intellectual property rights',
          wireframeType: 'list',
          items: [
        ...
        },
        {
          ...
          description:
            'Terms governing account termination, suspension, and data handling',
          wireframeType: 'list',
          items: [
        ...
        },
        {
          ...
          description:
            'Process for handling disputes, complaints, and legal matters',
          wireframeType: 'form',
          items: [
        ...
        },
        {
          ...
          description:
            'How we communicate changes to these terms and their effective dates',
          wireframeType: 'list',
          items: [
