...
export const metadata: Metadata = {
  ...
  description: 'Connect with local professionals, attend networking events, and access career resources in the Central Valley',
}
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Connect with local professionals and grow your career in the Central Valley
        </p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="border rounded-lg p-4">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="font-semibold">Healthcare Professionals Network</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="border rounded-lg p-4">
                  ...
                  <Button asChild size="sm" className="w-full">
                    <Link href="/community/mentorship/find">Browse Mentors</Link>
                  </Button>
                </div>
                <div className="border rounded-lg p-4">
                  ...
                  <Button asChild size="sm" variant="outline" className="w-full">
                    <Link href="/community/mentorship/apply">Apply to Mentor</Link>
                  </Button>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3 p-3 border rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">Senior Marketing Director • 12 years experience</p>
                      <div className="flex items-center mt-1">
                        <Badge variant="secondary" className="text-xs">Marketing</Badge>
                        <Badge variant="secondary" className="text-xs ml-1">Leadership</Badge>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center space-x-3 p-3 border rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">Software Engineering Manager • 15 years experience</p>
                      <div className="flex items-center mt-1">
                        <Badge variant="secondary" className="text-xs">Technology</Badge>
                        <Badge variant="secondary" className="text-xs ml-1">Career Growth</Badge>
                      </div>
                    </div>
                    <Button size="sm">Connect</Button>
                  </div>
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-green-500 pl-4">
                  <p className="text-sm text-gray-700 mb-2">
                    "Found my dream job in healthcare through the mentorship program!"
                  </p>
                  <p className="text-xs text-gray-500">- Maria R., Registered Nurse</p>
                </div>
                <div className="border-l-4 border-blue-500 pl-4">
                  <p className="text-sm text-gray-700 mb-2">
                    "The networking events helped me transition into tech successfully."
                  </p>
                  <p className="text-xs text-gray-500">- David L., Software Developer</p>
                </div>
                <div className="border-l-4 border-purple-500 pl-4">
                  <p className="text-sm text-gray-700 mb-2">
                    "Connected with local business owners and started my own company!"
                  </p>
                  <p className="text-xs text-gray-500">- Jennifer K., Entrepreneur</p>
                </div>
              </div>
