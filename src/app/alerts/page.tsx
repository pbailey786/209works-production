...
import { Plus, Edit3, Trash2, Play, Pause, Bell, Mail, Clock, Target } from 'lucide-react';
...
const FREQUENCY_OPTIONS = [
  { value: 'immediate', label: 'Immediate', description: 'Get notified as soon as new jobs match' },
  ...
  { value: 'monthly', label: 'Monthly', description: 'Monthly report on the 1st' },
];
  ...
  if (status === 'unauthenticated') {
    return (
      <div className="max-w-2xl mx-auto py-16 px-4 text-center">
        <h1 className="text-3xl font-bold mb-4">Job Alerts</h1>
        <p className="text-gray-700 mb-6">Please sign in to manage your job alerts.</p>
    ...
    <div className="max-w-6xl mx-auto py-8 px-4">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-2">Stay updated with job opportunities that match your preferences</p>
        </div>
        <div className="flex items-center space-x-3">
          <Button variant="outline" onClick={() => window.location.href = '/alerts/analytics'}>
            📊 Analytics
          </Button>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewAlert(prev => ({ ...prev, jobTitle: e.target.value }))}
                  />
                </div>
                <div>
                        ...
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => {
                            if (checked) {
                              ...
                              setNewAlert(prev => ({
                                ...prev,
                                jobTypes: prev.jobTypes.filter(t => t !== type.value)
                              }));
                            }
                          }}
                        />
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">{stats.emailStats.sent || 0}</p>
                </div>
              </div>
            </CardContent>
          </Card>
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {stats.emailStats.sent ? 
                      Math.round((stats.emailStats.delivered || 0) / stats.emailStats.sent * 100) : 0}%
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-600 mb-4">
                Create your first job alert to get notified about opportunities that match your preferences.
              </p>
            ...
            <Card key={alert.id}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <CardTitle className="text-lg">{alert.jobTitle || 'Job Alert'}</CardTitle>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm">{alert.location || 'Any location'}</p>
                  </div>
                  <div>
                ...
                {alert.stats && (
                  <div className="mt-4 pt-4 border-t grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    <div>
                      ...
                      <span className="ml-2 font-medium">{alert.stats.totalNotifications}</span>
                    </div>
                    <div>
                      <span className="text-gray-600">Recent matches:</span>
                      <span className="ml-2 font-medium">{alert.stats.recentMatches}</span>
                    </div>
                    <div>
