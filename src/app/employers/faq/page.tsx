      ...
      sections={[
        {
          ...
          description: "Common questions for new employers and basic platform usage",
          wireframeType: "list",
          items: [
        ...
        },
        {
          ...
          description: "Questions about creating, editing, and managing job listings",
          wireframeType: "list",
          items: [
        ...
        },
        {
          ...
          description: "Managing applications, screening candidates, and communication",
          wireframeType: "list",
          items: [
        ...
        },
        {
          ...
          description: "Questions about pricing, billing, credits, and subscription management",
          wireframeType: "list",
          items: [
        ...
        },
        {
          ...
          description: "Questions about AI tools, integrations, and premium features",
          wireframeType: "list",
          items: [
