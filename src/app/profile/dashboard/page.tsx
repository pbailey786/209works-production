...
const widgets = [
  ...
  },
  {
    ...
    content: <p className="text-gray-500 text-sm">New alert: "Remote jobs in Stockton"</p>,
  },
  {
    ...
    content: <p className="text-gray-500 text-sm">Resume_2025_V2.pdf</p>,
  },
  {
    title: "Cover Letters",
    description: "Create and store custom cover letters.",
    // TODO: Replace with real cover letter data from backend/API
    content: <p className="text-gray-500 text-sm">CoverLetter_MarketingRole.docx</p>,
  },
];
