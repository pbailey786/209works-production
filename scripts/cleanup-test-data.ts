...
async function cleanupTestData() {
  ...
  try {
    ...
    console.log(`  ✅ Deleted ${deletedInstagramPosts.count} test Instagram posts`);
    ...
    console.log(`  ✅ Deleted ${deletedTemplates.count} test Instagram templates`);
    ...
    console.log(`  ✅ Deleted ${deletedSchedules.count} test Instagram schedules`);
