...
const samplePosts = [
  {
    caption:
      '🚀 Exciting Software Engineer opportunity at TechCorp! Join our innovative team building the future of web applications. Remote-friendly with competitive benefits! #SoftwareEngineer #TechJobs #RemoteWork #WebDevelopment',
    type: 'job_listing',
    hashtags: [
      '#SoftwareEngineer',
      '#TechJobs',
  ...
  {
    caption:
      '💼 Marketing Manager position available at GrowthCo! Lead campaigns that drive real results. Excellent growth opportunities and team culture. Apply now! #MarketingJobs #DigitalMarketing #CareerGrowth #Marketing',
    type: 'job_listing',
    hashtags: [
      '#MarketingJobs',
      '#DigitalMarketing',
  ...
  {
    caption:
      '🎯 Data Scientist role at DataTech! Work with cutting-edge ML models and big data. Hybrid work model with amazing perks. #DataScience #MachineLearning #BigData #TechCareers',
    type: 'job_listing',
  ...
  {
    caption:
      "🌟 Spotlight on InnovateCorp - a company that's revolutionizing the fintech space! Their commitment to work-life balance and innovation makes them a top employer. #CompanySpotlight #Fintech #Innovation #WorkLifeBalance",
  ...
  {
    caption:
      '📈 Industry Insight: The tech job market is booming! 65% increase in remote positions and growing demand for AI/ML skills. Stay ahead of the curve! #TechTrends #JobMarket #RemoteWork #AI',
    type: 'industry_news',
  ...
  {
    caption:
      '🔧 UX Designer wanted at DesignStudio! Create beautiful, user-centered experiences. Portfolio review and competitive salary. #UXDesign #UserExperience #DesignJobs #Creative',
    type: 'job_listing',
  ...
  {
    caption:
      "💡 Career Tip Tuesday: Networking isn't just about collecting contacts - it's about building genuine relationships. Quality over quantity always wins! #CareerTips #Networking #ProfessionalDevelopment #CareerAdvice",
    type: 'custom',
    hashtags: [
      '#CareerTips',
      '#Networking',
  ...
  {
    caption:
      '🏢 Meet CloudTech - where innovation meets collaboration! Their open office culture and learning opportunities make them a standout employer. #CompanySpotlight #CloudComputing #TechCulture #Innovation',
    type: 'company_highlight',
    hashtags: [
      '#CompanySpotlight',
      '#CloudComputing',
  ...
  {
    caption:
      '⚡ DevOps Engineer opportunity at ScaleCorp! Build and maintain infrastructure that powers millions of users. Kubernetes, AWS, and more! #DevOps #CloudInfrastructure #AWS #Kubernetes #TechJobs',
    type: 'job_listing',
    hashtags: [
      '#DevOps',
      '#CloudInfrastructure',
  ...
  {
    caption:
      '📊 Market Update: Salary trends show 15% increase for software engineers, 12% for data scientists. The talent shortage continues to drive competitive compensation! #SalaryTrends #TechSalaries #JobMarket #TechCareers',
    type: 'industry_news',
...
async function seedInstagramAnalytics() {
  ...
  try {
    ...
    for (let i = 0; i < samplePosts.length; i++) {
      ...
      console.log(
        `Creating post ${i + 1}/${samplePosts.length}: ${postData.caption.substring(0, 50)}...`
      );
      ...
      const engagementRate =
        analytics.impressions > 0
          ? (totalEngagements / analytics.impressions) * 100
          : 0;
      const clickThroughRate =
        analytics.impressions > 0
          ? (analytics.websiteClicks / analytics.impressions) * 100
          : 0;
