...
describe('Input Component', () => {
  ...
  describe('Custom Props', () => {
    ...
    it('accepts custom id', () => {
      renderWithProviders(<Input id="unique-input" data-testid="id-input" />);
    ...
    it('accepts name attribute', () => {
      renderWithProviders(<Input name="username" data-testid="name-input" />);
    ...
    it('accepts required attribute', () => {
      renderWithProviders(<Input required data-testid="required-input" />);
    ...
    it('accepts disabled attribute', () => {
      renderWithProviders(<Input disabled data-testid="disabled-input" />);
    ...
    it('accepts readonly attribute', () => {
      renderWithProviders(<Input readOnly data-testid="readonly-input" />);
    ...
    it('accepts min and max attributes for number input', () => {
      renderWithProviders(
        <Input type="number" min={1} max={100} data-testid="number-input" />
      );
  ...
  describe('Form Integration', () => {
    it('integrates with form validation', async () => {
      ...
      renderWithProviders(
        <form>
          <Input type="email" required data-testid="validation-input" />
  ...
  describe('Ref Forwarding', () => {
    it('forwards ref correctly', () => {
      ...
      renderWithProviders(<Input ref={ref} data-testid="ref-input" />);
  ...
  describe('Accessibility', () => {
    ...
    it('supports aria-describedby', () => {
      renderWithProviders(
        <div>
          <Input aria-describedby="help-text" data-testid="describedby-input" />
  ...
  describe('Edge Cases', () => {
    it('handles empty className gracefully', () => {
      renderWithProviders(<Input className="" data-testid="empty-class" />);
