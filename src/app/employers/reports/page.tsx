...
export default function EmployerReportsPage() {
  const reportsSections = [
    ...
    },
    {
      ...
      items: ["Job Title", "Views", "Applications", "Click Rate", "Time to Fill", "Quality Score"]
    },
    {
    ...
    },
    {
      ...
      wireframeType: "table" as const,
      items: ["Metric", "Your Performance", "Industry Average", "Top Performers", "Improvement %"]
    }
  ];
  ...
  const quickActions = [
    ...
    },
    {
      ...
      description: "Get automated performance summaries delivered to your email",
      icon: "📅",
