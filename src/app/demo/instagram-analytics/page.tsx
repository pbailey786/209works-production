...
export const metadata: Metadata = {
  ...
  description: 'Demo of the Instagram analytics and engagement tracking dashboard',
};
      ...
      <div className="mb-8">
        ...
        <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm text-blue-800">
            <strong>Demo Note:</strong> This dashboard shows the Instagram analytics interface. 
            In a production environment, this would display real data from your Instagram Business Account 
