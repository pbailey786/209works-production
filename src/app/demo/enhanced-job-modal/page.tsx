...
const sampleJobs = [
  {
    ...
    postedAt: '2024-01-15',
    description: 'We are looking for a talented Senior Software Engineer to join our dynamic team. You will be responsible for developing high-quality software solutions and leading technical initiatives.',
  ...
  },
  {
    ...
    postedAt: '2024-01-10',
    description: 'Join our marketing team to drive product adoption and create compelling marketing campaigns. Experience with B2B marketing and analytics required.',
  ...
  },
  {
    ...
    location: 'Remote',
    postedAt: '2024-01-12',
    description: 'Analyze large datasets to provide actionable insights for business decisions. Strong SQL and Python skills required.',
  ...
  },
  {
    ...
    location: 'Austin, TX',
    postedAt: '2024-01-08',
    description: 'Create beautiful and intuitive user experiences for our digital products. Portfolio showcasing mobile and web design required.',
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Click "View Details" on any job card below to experience the enhanced job modal 
            with comprehensive job information, tabbed navigation, and improved user experience.
          </p>
        </div>

        {/* Features Overview */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Enhanced Modal Features</h2>
        ...
        <div className="mt-12 bg-blue-50 border border-blue-200 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-blue-900 mb-2">Try These Features:</h3>
          <ul className="space-y-2 text-blue-800">
            <li className="flex items-start">
              <span className="font-semibold mr-2">•</span>
              Click "View Details" to open the enhanced modal with rich job information
            </li>
            <li className="flex items-start">
              <span className="font-semibold mr-2">•</span>
              Navigate between tabs: Overview, Job Details, Company Info, and Apply
            </li>
            <li className="flex items-start">
              <span className="font-semibold mr-2">•</span>
            ...
            <li className="flex items-start">
              <span className="font-semibold mr-2">•</span>
              Close the modal using the X button, clicking outside, or pressing Escape
            </li>
            <li className="flex items-start">
              <span className="font-semibold mr-2">•</span>
