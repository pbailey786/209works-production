      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-4">
          <div className="bg-white rounded-lg px-4 py-2 shadow-sm border">
            ...
            <div className="text-xl font-semibold text-orange-600">{moderationStats.pending}</div>
          </div>
          <div className="bg-white rounded-lg px-4 py-2 shadow-sm border">
            <div className="text-sm text-gray-500">Flagged</div>
            <div className="text-xl font-semibold text-red-600">{moderationStats.flagged}</div>
          </div>
          <div className="bg-white rounded-lg px-4 py-2 shadow-sm border">
            <div className="text-sm text-gray-500">Total</div>
            <div className="text-xl font-semibold text-gray-900">{moderationStats.total}</div>
          </div>
        </div>
      </div>
