...
describe('useErrorHandler Hook', () => {
  it('throws error when captureError is called', () => {
    ...
    expect(screen.getByText('Something went wrong')).toBeInTheDocument()
    expect(screen.queryByText('Hook component rendered')).not.toBeInTheDocument()
  })
...
describe('FormErrorBoundary Component', () => {
  ...
  it('displays form-specific error UI when child throws', () => {
    ...
    expect(screen.getByText('There was an error processing your form. Please refresh the page and try again.')).toBeInTheDocument()
    expect(screen.getByTestId('alert-circle-icon')).toBeInTheDocument()
  })
