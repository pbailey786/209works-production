  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Adzuna Job Import</h1>
          <p className="mt-2 text-gray-600">
            Import jobs from Adzuna API to populate your job board with 209 area code opportunities
          </p>
          <div className="mt-3 space-y-2">
            <div className="text-sm text-blue-600 bg-blue-50 px-3 py-2 rounded-lg inline-block">
              🎯 Hyper-local focus: Stockton, Modesto, Tracy, Manteca, Lodi, Turlock, Merced + 18 more 209 cities
            </div>
            <div className="text-sm text-green-600 bg-green-50 px-3 py-2 rounded-lg inline-block">
              🚫 Enhanced filtering: Removes remote jobs, MLM/insurance spam, and repetitive postings
            </div>
          </div>
        </div>
            ...
            <div className="flex">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-yellow-700">
                  Please add ADZUNA_APP_ID and ADZUNA_APP_KEY to your environment variables to enable job imports.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-blue-50 p-4 rounded-lg">
                      ...
                      <div className="text-sm text-blue-800">Total Adzuna Jobs</div>
                    </div>
                    ...
                    <div className="bg-green-50 p-4 rounded-lg">
                      ...
                      <div className="text-sm text-green-800">Recent Jobs (7 days)</div>
                    </div>
                  </div>

                  <div className="border-t pt-4">
                    <h3 className="font-medium text-gray-900 mb-2">Import Timeline</h3>
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        <span className="text-gray-600">Oldest Job:</span>
                        <span className="font-medium">{formatDate(stats.oldestJob)}</span>
                      </div>
                      <div className="flex justify-between">
                  ...
                  <div className="border-t pt-4">
                    <h3 className="font-medium text-gray-900 mb-2">Jobs by Type</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <label className="flex items-center">
                    ...
                    />
                    <span className="text-sm text-gray-700">Filter low-quality jobs</span>
                  </label>
                  ...
                  <label className="flex items-center">
                    <input
                      ...
                      className="mr-2 h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <span className="text-sm text-gray-700">Clean up old jobs first</span>
                  </label>
                </div>
              </div>
            </div>
                  ...
                  {importResult.success && (
                    <div className="mt-2 text-sm text-green-700">
                      <div className="grid grid-cols-4 gap-4">
                        <div>Imported: <span className="font-medium">{importResult.stats.imported}</span></div>
                        <div>Skipped: <span className="font-medium">{importResult.stats.skipped}</span></div>
                        <div>Duplicates: <span className="font-medium">{importResult.stats.duplicates}</span></div>
                        <div>Errors: <span className="font-medium">{importResult.stats.errors}</span></div>
                      </div>
                    </div>
                  )}
