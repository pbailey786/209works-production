    ...
    <PlaceholderPage
      ...
      quickActions={[
        ...
        },
        {
          ...
          label: 'Live Chat',
          description:
            'Get instant help during business hours (Mon-Fri 9AM-6PM PST)',
          icon: '💬',
          disabled: true,
        },
        {
          ...
          description:
            'Priority support for critical issues (Enterprise plans only)',
          icon: '🚨',
          disabled: true,
        },
      ]}
      sections={[
        ...
        },
        {
          ...
          description:
            'Select the category that best describes your issue for faster resolution',
          wireframeType: 'list',
          items: [
        ...
        },
        {
          ...
          description:
            'Expected response times based on your plan and issue priority',
          wireframeType: 'table',
          items: [
            'Plan Type',
            'Email Response',
