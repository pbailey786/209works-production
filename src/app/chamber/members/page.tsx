...
export const metadata: Metadata = {
  ...
  description: 'Browse and connect with chamber of commerce members in the Central Valley',
}
  ...
  const members = [
    {
      ...
      description: "Leading business organization serving the greater Stockton area",
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Connect with chamber members and local businesses across the Central Valley
        </p>
      </div>
          ...
          <Card key={member.id} className="hover:shadow-lg transition-shadow">
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-center space-x-3">
                  <Avatar className="h-12 w-12">
                    <AvatarImage src={member.logo} alt={`${member.name} logo`} />
                    <AvatarFallback>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <div className="text-lg font-semibold text-blue-600">{member.memberCount}</div>
                  <div className="text-xs text-gray-500">Employees</div>
                </div>
                <div>
                  <div className="text-lg font-semibold text-green-600">{member.activeJobs}</div>
                  <div className="text-xs text-gray-500">Active Jobs</div>
                </div>
                <div>
                  <div className="text-lg font-semibold text-purple-600">{member.successfulHires}</div>
              ...
              <div className="flex gap-2 pt-2">
                <Button asChild size="sm" className="flex-1">
                  <Link href={`/jobs?company=${encodeURIComponent(member.name)}`}>
        ...
        <CardContent className="pt-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">
              Connect with local businesses and access exclusive benefits for chamber members
            </p>
