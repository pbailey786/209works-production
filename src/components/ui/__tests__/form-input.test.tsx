...
jest.mock('lucide-react', () => ({
  ...
  EyeOff: ({ className }: { className?: string }) => (
    <div className={className} data-testid="eyeoff-icon">
      EyeOff
    </div>
  ),
    ...
    it('shows strength indicator when enabled', async () => {
      ...
      expect(
        screen.getByText((content, element) => {
          return (
            (element?.tagName === 'P' &&
              element?.textContent?.includes('Password strength: Weak')) ||
            false
          );
        })
      ).toBeInTheDocument();
    ...
    it('calculates password strength correctly', async () => {
      ...
      expect(
        screen.getByText((content, element) => {
          return (
            (element?.tagName === 'P' &&
              element?.textContent?.includes('Password strength: Medium')) ||
            false
          );
        })
      ).toBeInTheDocument();
      ...
      expect(
        screen.getByText((content, element) => {
          return (
            (element?.tagName === 'P' &&
              element?.textContent?.includes('Password strength: Strong')) ||
            false
          );
        })
      ).toBeInTheDocument();
...
describe('FormTextarea', () => {
  describe('Basic Functionality', () => {
    it('renders textarea with label', () => {
      render(
        <FormTextarea label="Description" placeholder="Enter description" />
      );
...
describe('FileInput', () => {
  ...
  describe('File Configuration', () => {
    it('sets accept attribute for file types', () => {
      render(<FileInput acceptedFileTypes={['image/jpeg', 'image/png']} />);
