          ...
          return (
            <div key={job.id} className="px-6 py-4 hover:bg-gray-50">
              <div className="grid grid-cols-12 gap-4 items-center">
                ...
                {/* Status */}
                <div className="col-span-2">
                  <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${moderationStatus.color}`}>
                ...
                <div className="col-span-1 relative">
                  <button
                    onClick={() => setActionsOpen(actionsOpen === job.id ? null : job.id)}
