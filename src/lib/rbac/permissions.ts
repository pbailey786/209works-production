...
export function canAccessRoute(userRole: string, route: string): boolean {
  const routePermissions: Record<string, Permission[]> = {
    ...
    '/admin/email': [Permission.MANAGE_EMAIL_TEMPLATES],
    '/admin/email/templates': [Permission.MANAGE_EMAIL_TEMPLATES],
    '/admin/email/campaigns': [Permission.MANAGE_EMAIL_TEMPLATES],
    '/admin/email/test': [Permission.MANAGE_EMAIL_TEMPLATES],
