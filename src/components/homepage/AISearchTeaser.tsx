    ...
    <div className="mx-auto max-w-4xl">
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-2xl border-2 border-gray-200 bg-gray-50 py-4 pl-20 pr-6 text-lg transition-all duration-200 focus:border-orange-500 focus:bg-white focus:outline-none focus:ring-4 focus:ring-orange-500/20"
              />
            </div>
            <button
              type="submit"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {suggestedSearches.map((suggestion, index) => (
          <button
            ...
            className="group flex items-center justify-between rounded-2xl border-2 border-gray-200 bg-white/80 p-4 text-left backdrop-blur-sm transition-all duration-200 hover:border-orange-300 hover:bg-orange-50 hover:scale-105"
          >
      ...
      <div className="mt-6 text-center">
        <p className="text-sm text-gray-600">
          <span className="font-semibold text-orange-600">JobsGPT</span> understands Central Valley geography and job market.
