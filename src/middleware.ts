...
export default clerkMiddleware(async (auth, req) => {
  ...
  console.log('🌐 Domain config:', domainConfig.displayName, domainConfig.areaCode);
  ...
  // Add domain context headers for the application
  const response = NextResponse.next();
  response.headers.set('x-domain', domainConfig.domain);
  response.headers.set('x-region', domainConfig.areaCode);
  response.headers.set('x-region-name', domainConfig.region);
  response.headers.set('x-display-name', domainConfig.displayName);
