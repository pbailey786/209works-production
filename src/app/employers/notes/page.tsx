    ...
    <PlaceholderPage
      ...
      sections={[
        ...
        },
        {
          ...
          description:
            'Create and organize custom tags for candidate categorization',
          wireframeType: 'cards',
          items: [
        ...
        },
        {
          title: 'Search & Filter',
          description:
            'Advanced search and filtering options for notes and candidates',
          wireframeType: 'form',
          items: [
        ...
        },
        {
          ...
          description:
            'Predefined categories to organize different types of notes',
          wireframeType: 'list',
          items: [
        ...
        },
        {
          ...
          description:
            'Apply tags and actions to multiple candidates efficiently',
          wireframeType: 'form',
          items: [
        ...
        },
        {
          ...
          description:
            'Additional features for power users and enterprise needs',
          wireframeType: 'list',
          items: [
