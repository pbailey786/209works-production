...
describe('JobCard', () => {
  ...
  it('renders apply link with correct attributes', () => {
    ...
    const applyLink = screen.getByRole('link', { name: /apply for senior frontend developer at tech corp/i });
  ...
  it('does not apply selected styles when isSelected is false', () => {
    ...
    const card = screen.getByTestId('job-card-Senior Frontend Developer');
    expect(card).not.toHaveClass('border-purple-600', 'ring-2', 'ring-purple-200');
  ...
  describe('View Details functionality', () => {
    it('shows view details button when onViewDetails is provided', () => {
      ...
      expect(screen.getByTestId('view-details-Senior Frontend Developer')).toBeInTheDocument();
    ...
    it('calls onViewDetails when view details button is clicked', async () => {
      ...
      const viewDetailsButton = screen.getByTestId('view-details-Senior Frontend Developer');
    ...
    it('prevents event propagation when view details button is clicked', async () => {
      ...
      render(<JobCard {...mockJobData} onClick={mockOnClick} onViewDetails={mockOnViewDetails} />);
    ...
    it('changes apply button style when view details is available', () => {
      ...
      expect(applyButton).toHaveClass('bg-white', 'text-purple-700', 'border', 'border-purple-200');
  ...
  describe('Save functionality', () => {
    it('shows save button when onSave is provided', () => {
      ...
      expect(screen.getByTestId('save-Senior Frontend Developer')).toBeInTheDocument();
    ...
    it('does not show save button when onSave is not provided', () => {
      ...
      expect(screen.queryByTestId('save-Senior Frontend Developer')).not.toBeInTheDocument();
    });
    ...
    it('prevents event propagation when save button is clicked', async () => {
      ...
      render(<JobCard {...mockJobData} onClick={mockOnClick} onSave={mockOnSave} />);
    ...
    it('shows saved state when saved is true', () => {
      ...
      expect(saveButton).toHaveClass('bg-green-100', 'text-green-700', 'cursor-not-allowed');
  ...
  describe('Accessibility', () => {
    it('has proper ARIA attributes', () => {
      ...
      expect(card).toHaveAttribute('aria-pressed', 'true');
      expect(card).toHaveAttribute('aria-label', 'Job listing for Senior Frontend Developer at Tech Corp');
    });
    ...
    it('has proper aria-labels for buttons', () => {
      ...
      expect(viewDetailsButton).toHaveAttribute('aria-label', 'View details for Senior Frontend Developer at Tech Corp');
      expect(saveButton).toHaveAttribute('aria-label', 'Save Senior Frontend Developer');
      expect(applyLink).toHaveAttribute('aria-label', 'Apply for Senior Frontend Developer at Tech Corp');
    });
  ...
  describe('Edge cases', () => {
    ...
    it('handles empty description', () => {
      ...
      expect(screen.getByTestId('job-card-Senior Frontend Developer')).toBeInTheDocument();
    });

    it('handles long job titles', () => {
      const longTitle = 'Senior Full Stack Software Engineer with React, Node.js, and Cloud Experience';
