  ...
  return (
    <div className="max-w-md mx-auto py-8 sm:py-12 md:py-16 px-4">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sm:p-8">
        <h1 className="text-2xl sm:text-3xl font-bold mb-6 text-center leading-tight">
          Sign In
        </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full border border-gray-300 p-3 sm:p-4 rounded-lg focus:ring-2 focus:ring-[#2d4a3e] focus:border-[#2d4a3e] transition-colors duration-200 text-base pr-12"
                value={password}
          ...
          <div className="flex justify-between items-center">
            <Link href="/password-reset-request" className="text-sm text-[#2d4a3e] hover:text-[#1d3a2e] font-medium">
              Forgot password?
            </Link>
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-[#ff6b35] text-white py-3 sm:py-4 rounded-lg font-semibold hover:bg-[#e55a2b] focus:ring-2 focus:ring-[#ff6b35] focus:ring-offset-2 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed min-h-[48px] flex items-center justify-center"
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            New to 209 Works?{' '}
            <Link href="/signup" className="text-[#2d4a3e] hover:text-[#1d3a2e] font-medium">
              Join now
            </Link>
          </p>
        </div>
