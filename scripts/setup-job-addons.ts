...
import { PrismaClient, PricingTier, AddOnCategory, AddOnType, BillingInterval, UserRole } from '@prisma/client';
...
const JOB_ADDONS = [
  // Job Promotion Addons
  {
    ...
    description: 'Promote your job posting across our social media channels (Instagram, X/Twitter) to reach a wider audience of local job seekers.',
    ...
    currency: 'USD',
    compatibleTiers: [PricingTier.basic, PricingTier.essential, PricingTier.professional, PricingTier.enterprise, PricingTier.premium],
  ...
  
  {
    ...
    description: 'Boost your job posting to the top of search results and featured sections for maximum visibility to job seekers.',
...

  {
    ...
    description: 'Get both social media promotion AND featured placement at a discounted price. Maximum exposure for your job posting.',
  ...
  // Additional Job Posts
  {
    ...
    slug: 'extra-jobs-3',
    description: 'Add 3 more job postings to your account. Perfect for growing businesses with multiple open positions.',
...

  {
    ...
    slug: 'extra-jobs-5',
    description: 'Add 5 more job postings to your account. Great value for companies with multiple hiring needs.',
...

  {
    ...
    slug: 'extra-jobs-10',
    description: 'Add 10 more job postings to your account. Best value for large-scale hiring or staffing agencies.',
