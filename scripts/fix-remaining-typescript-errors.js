...
const specificFixes = {
  'src/app/admin/users/page.tsx': [
    ...
    {
      search:
        /import \{\s*Table,\s*TableBody,\s*TableCell,\s*TableHead,\s*TableHeader,\s*TableRow\s*\} from 'lucide-react';/,
      replace:
        "import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@/components/ui/table';",
    },
    {
      search:
        /\s*DropdownMenu,\s*DropdownMenuContent,\s*DropdownMenuItem,\s*DropdownMenuTrigger\s*\} from '@\/components\/ui\/dropdown-menu';/,
      replace:
  ...
  'src/app/api/chat-job-search/route.ts': [
    {
      search:
        /import \{\s*type AISecurityContext,\s*sanitizeUserData \} from '@\/lib\/middleware\/ai-security';/,
      replace:
        "import { type AISecurityContext, sanitizeUserData } from '@/lib/middleware/ai-security';",
    },
  ],
  ...
  'src/components/forms/ExampleRegistrationForm.tsx': [
    {
      ...
      replace:
        "import { validateFormData, sanitizeInput } from '@/lib/validations/form-utils';",
    },
  ],
