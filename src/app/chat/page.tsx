...
**How can I help you today?**`,
  ...
  const suggestedPrompts = [
    "Find software engineering jobs in Stockton",
    "What companies are hiring in the 209 area?",
    "Show me healthcare jobs in Modesto",
    "Tell me about working at Amazon in Tracy",
    "Find remote jobs for 209 residents",
      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="flex items-center justify-between border-b border-gray-200 bg-white px-4 py-3">
          ...
          <div className="text-xs text-gray-500">
            {user ? `Signed in as ${user.firstName || user.emailAddresses[0]?.emailAddress}` : 'Guest'}
          </div>
        </div>
