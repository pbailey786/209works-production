      ...
      sections={[
        {
          ...
          description: "Types of data we collect from employers and how we collect it",
          wireframeType: "list",
          items: [
        ...
        },
        {
          ...
          description: "Purposes for which we process your company and user data",
          wireframeType: "list",
          items: [
        ...
        },
        {
          ...
          description: "How we handle candidate information you access through our platform",
          wireframeType: "list",
          items: [
        ...
        },
        {
          ...
          description: "Security practices and technologies we use to protect your data",
          wireframeType: "cards",
          items: [
        ...
        },
        {
          ...
          description: "Rights you have regarding your data and how to exercise them",
          wireframeType: "form",
          items: [
            "Data Access Request",
        ...
        },
        {
          ...
          description: "How we handle data transfers across international borders",
          wireframeType: "list",
          items: [
        ...
        },
        {
          ...
          description: "Information about cookies, analytics, and tracking technologies",
          wireframeType: "list",
          items: [
