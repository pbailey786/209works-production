    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center text-xs text-muted-foreground">
              ...
              <span className={jobGrowth >= 0 ? "text-green-500" : "text-red-500"}>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center text-xs text-muted-foreground">
              ...
              <span className={applicationGrowth >= 0 ? "text-green-500" : "text-red-500"}>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{activeAlerts.toLocaleString()}</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>User and job posting trends over time</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <TabsContent value="jobs" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Most popular job categories and their growth</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {jobPostingData.map((category) => (
                  <div key={category.category} className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className={`text-sm ${category.growth >= 0 ? 'text-green-500' : 'text-red-500'}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <CardContent>
                <div className="h-[300px] flex items-center justify-center bg-gray-50 rounded-lg">
                  <div className="text-center">
                    ...
                    <p className="text-gray-500">Search analytics visualization</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Alert emails and newsletter metrics</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
